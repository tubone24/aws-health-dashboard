    ...
    <>
      <RecoilRoot>
        <Head>
          ...
          <meta property="og:description" content="This is a web page where you can check the status of AWS. The official AWS Service Health Dashboard is difficult to use, so I recreated it using Next.js Vercel." />
          <meta name="keywords" content="AWS, status" />
          <meta property="og:type" content="website" />
          <meta property="og:url" content="https://aws-health-dashboard.vercel.app/" />
          ...
          <meta name="twitter:url" content="https://aws-health-dashboard.vercel.app/" />
          <meta name="twitter:title" content="AWS Health Dashboard" />
          <meta name="twitter:description" content="This is a web page where you can check the status of AWS." />
